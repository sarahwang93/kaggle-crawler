...
class kagglesingle:
    def testsingleurl(self, url, count, outputstr, visited):
                ...
                if fork_parent_url == "":
                    ...
                    if fork_parent_url_combine not in visited:
                        ...
                        if count <= len(visited):
                            self.testsingleurl(fork_parent_url_combine, count, outputstr, visited)
                    else:
                        pass
...
if __name__ == '__main__':
    ...
    startCount = 0
    visitedArr = []
    print("test: " + str(test_url.testsingleurl(singleUrl, startCount, startStr, visitedArr)))
    print(visitedArr)
